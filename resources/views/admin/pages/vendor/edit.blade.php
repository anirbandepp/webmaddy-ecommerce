...
@section('content')
    ...
    <div class="page-header page-header-default">
        <div class="page-header-content">
            <div class="page-title">
                <h4><span class="text-semibold">Vendor</span> - Edit Vendor</h4>
            </div>
        </div>
    </div>
    <!-- /page header -->
    ...
    <div class="content content-product-add">
        <div class="row">
            ...
            <form action="{{ route('administrator.vendor.update_vendor') }}" method="POST"
                    ...
                    <div class="panel panel-flat pd-20">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="vendor_name" id="vendor_name" class="form-control pr-title"
                                placeholder="Vendor name" value="{{ $vendor->vendor_name }}" />
                            @error('vendor_name')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="vendor_email" id="vendor_email" class="form-control pr-title"
                                placeholder="Vendor name" value="{{ $vendor->vendor_email }}" />
                            @error('vendor_email')
                                <span class="err">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" name="vendor_phone" id="vendor_phone" class="form-control pr-title"
                                placeholder="Vendor name" value="{{ $vendor->vendor_phone }}" />
                            @error('vendor_phone')
                                <span class="err">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" rows="5" id="address_line1" name="address_line1">{{ $vendor->address_line1 }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" rows="5" id="address_line2" name="address_line2">{{ $vendor->address_line2 }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="city" id="city" class="form-control pr-title"
                                placeholder="Vendor City" value="{{ $vendor->city }}" />
                            @error('city')
                                <span class="err">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="state" id="state" class="form-control pr-title"
                                placeholder="Vendor state" value="{{ $vendor->state }}" />
                            @error('state')
                                <span class="err">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="country" id="country" class="form-control pr-title"
                                placeholder="Vendor country" value="{{ $vendor->country }}" />
                            @error('country')
                                <span class="err">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="admin_action" name="admin_action">
                                <option value="1" {{ $vendor->admin_action == 1 ? 'selected' : '' }}>Active</option>
                                <option value="0" {{ $vendor->admin_action == 0 ? 'selected' : '' }}>Inactive</option>
                            </select>
                        </div>
                ...
                <div class="col-md-3">
                    ...
                    <div class="panel panel-flat">
                        ...
                        <div class="panel-body" style="display: block;">
                            <input type="submit" class="btn btn-success btn-block" value="Update Vendor">
