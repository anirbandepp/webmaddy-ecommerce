...
<div class="content content-product-add">
	<div class="row">
        <form action="{{ route('administrator.category.create_sub_category') }}" onsubmit="return category_add_fx()" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="col-md-9">
            <div class="panel panel-flat pd-20" >
                ...
                <div class="form-group">
                    ...
                    <input type="file" id="catimg" name="catimg" class="form-control pr-title" placeholder="Category Image">
                </div>
                <div class="form-group">
                    <label for="name">Category Name</label>
                    <input type="text" class="form-control pr-title" id="name" name="name" placeholder="Enter category name" />
                </div>
                <div class="form-group">
                    <label for="offer_percentage">Offer Percentage</label>
                    <input type="number" class="form-control pr-title" id="offer_percentage" name="offer_percentage"
		...
		<div class="col-md-3">
			...
			<div class="panel panel-flat">
				<div class="panel-heading">
					<h5 class="panel-title">Publish <a class="heading-elements-toggle"><i class="icon-more"></i></a></h5>
